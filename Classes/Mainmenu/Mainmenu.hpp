...
public:
  ...
  ///Mainmenu Parts
  //Header
  void Logos();//CONFIGURAÇOES DA LOGO SPOCFY
  void Search();//CONFIGURAÇOES DA PARTE SEARCH
  void PublicPlaylist(); //PUBLIC PLAYLIST CONFIGS, são pra mostrar as pastas com cada g�nero
  void User();//CONFIGURAÇOES DA PARTE USER DO HEADER
